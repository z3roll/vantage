...
:func:`vantage.forward.strategy.routing._walk_isl_path_row` against the
predecessor rows exposed through :class:`vantage.control.plane.SatPathTable`
(which the controller builds from the snapshot each refresh).
"""
...
from vantage.model.satellite.state import ISLGraph
