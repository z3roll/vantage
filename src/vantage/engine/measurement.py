...
flow has been charged against the :class:`~vantage.domain.UsageBook`.
...
:class:`~vantage.domain.FlowOutcome`.
...
if TYPE_CHECKING:
    from vantage.domain import SatPathTable, UsageBook
    from vantage.forward import EgressOption, PathDecision


__all__ = ["ResolvedFlow", "measure_flow"]
...
def measure_flow(
    ...
    *,
    ...
    the current :class:`~vantage.domain.UsageBook` state.
    ...
    :class:`~vantage.engine.context.GroundTruth`. ``None`` (the
